...
const seedDataGenerator_1 = require("../src/seed/seedDataGenerator");
const networkGraph_1 = require("../src/topology/networkGraph");
const telemetryProcessor_1 = require("../src/ingest/telemetryProcessor");
const scheduledOutageMatcher_1 = require("../src/localization/scheduledOutageMatcher");
const faultDetector_1 = require("../src/localization/faultDetector");
const ticketEngine_1 = require("../src/tickets/ticketEngine");
const faultSimulator_1 = require("../src/simulator/faultSimulator");
describe('KSPDB Fault Localization Engine Test Suite', () => {
    ...
    let faultSimulator;
    beforeEach(() => {
        const seed = (0, seedDataGenerator_1.generateSeedNetwork)();
        networkGraph = new networkGraph_1.NetworkGraph();
        networkGraph.initialize(seed.substations, seed.feeders, seed.transformers, seed.poles);
        telemetryProcessor = new telemetryProcessor_1.TelemetryProcessor(networkGraph);
        outageMatcher = new scheduledOutageMatcher_1.ScheduledOutageMatcher();
        faultDetector = new faultDetector_1.FaultDetector(networkGraph, telemetryProcessor, outageMatcher);
        ticketEngine = new ticketEngine_1.TicketEngine(faultDetector, telemetryProcessor);
        faultSimulator = new faultSimulator_1.FaultSimulator(networkGraph, telemetryProcessor, outageMatcher);
    ...
    test('Single Span Fault produces exactly 1 localized SPAN_FAULT incident ticket', () => {
        ...
        expect(spanFaults[0].span_end_pole_id).toBe(targetPoleId);
